...
export class MainContainerScrollService {
  private readonly blistenScrollTop: BehaviorSubject<number> = new BehaviorSubject<number>(0);
  listenScrollTop$: Observable<number> = this.blistenScrollTop.asObservable();

  private readonly blistenScrollBottom: BehaviorSubject<number> = new BehaviorSubject<number>(0);
  listenScrollBottom$: Observable<number> = this.blistenScrollBottom.asObservable();

  private readonly bDirectionPostion: BehaviorSubject<DirectionPostion | null> = new BehaviorSubject<DirectionPostion | null>(null);
